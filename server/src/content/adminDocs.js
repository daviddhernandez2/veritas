...
export const adminDocs = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'p', text: 'Al llegar a 3 reportes distintos sobre el mismo post: status pasa a "hidden", el autor pierde 10 puntos de reputación (suelo 0, campo User.reputation, empieza en 50), y se recalcula en cascada el reliabilityAgg de sus ancestros para que dejen de contar esa fuente — igual que si el post se hubiera "eliminado" a efectos de la fórmula.' },
